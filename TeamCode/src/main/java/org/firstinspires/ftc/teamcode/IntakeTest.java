...
public class IntakeTest extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException{
        ...
        while (opModeIsActive()) {
            ...
            vexMotor0.setPower(gamepad2.left_stick_y);
            vexMotor1.setPower(gamepad2.left_stick_y);
            vexMotor2.setPower(gamepad2.left_stick_y);
            vexMotor3.setPower(gamepad2.left_stick_y);
/*
;
